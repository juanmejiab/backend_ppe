  ...
  <section class="w3l-inner-page-breadcrumb">
    <div class="breadcrumb-bg py-5">
      <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3 my-lg-3">
        <h2 class="title pt-5">Acerca de</h2>
        <ul class="breadcrumbs-custom-path mt-3 text-center">
          <li><a href="index.html">Inicio</a></li>
          <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> Acerca de </li>
        </ul>
      </div>
    </div>
  </section>
      ...
      <div class="container py-lg-5 py-md-4 py-2">
        <div class="row">
          ...
          <div class="col-lg-7 pl-lg-5 align-self">
            <p class=""> Somos una empresa comprometida con el Desarrollo de software ayudamos a todo el mundo a tener
              una nueva perspectiva con las metodologias y sus usos
            </p>
            <p class="mt-4"> Nos enfocamos especificamente en cumplir todas las expectativas de nuesttros clientes tanto
              en desarrollo de aplicacion con unos sofwares muy eficientes, siempre brindando la mejor calidad
            </p>
        ...
        <div class="col-lg-6 whybox-wrap pr-lg-5">
          ...
          <div class="whybox-wrap-grid mb-4">
            ...
            <div class="info">
              ...
              <p class="mt-3">tambien asesoramos en las mejores metodologias agiles actuales para la estructura del
                sofware </p>
            </div>
          </div>
        </div>
      ...
      <div class="container py-lg-5 py-md-4 py-2">
        <div class="row">
          <div class="col-lg-6 left-wthree-img">
            <img src="images/b2.jpg" class="img-fluid radius-image" alt="">
          ...
          <div class="col-lg-6 mt-lg-0 mt-5 pl-lg-5 align-self">
            ...
            <p class=""> Nos centramos en las necesidades de todas las pequeñas y medianas empresas del mercado para
              mejorar y crecer.
              ayudando asi al Desarrolo tecnologico del pais asi creciendo juntos en las nuvas tecnologias como software
              aplicaciones y Inteligencia artificial </p>
    ...
    <div class="footer-29-w3l py-5">
      <div class="container py-lg-5 py-md-3">
        <div class="w3l-footer-texthny-inf text-center">
          <h6 class="foot-sub-title mb-1">Hecho por:</h6>
          <h4 class="mail">Juan Pablo Mejía Betancur - <a
              href="mailto:juan.mejiab@upb.edu.co">juan.mejiab@upb.edu.co</a></h4>
          <h4 class="mail">Juan Pablo Vásquez Baena - <a
              href="mailto:juanp.vasquezb@upb.edu.co">juanp.vasquezb@upb.edu.co</a></h4>
