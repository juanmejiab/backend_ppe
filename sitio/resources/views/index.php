...
<body>
  <a href="https://wa.me/+573163138432" target="_blank">
    <img src="https://icons.iconarchive.com/icons/social-media-icons/glossy-social/72/Whatsapp-icon.png"
      id="btn_whatsapp" alt="">
  </a>
  <!--/header-w3l-->
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav ml-lg-auto">
              <li class="nav-item active">
                <a class="nav-link" href="resources/views/index">Inicio</a>
              </li>
              <li class="nav-item">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 bannerhny-info pr-lg-5">
          ...
          <p class="pr-lg-5 mt-md-4 mt-3">Somos tu mejor opción para el desarrollo de tus servicios electrónicos y
            potenciar tu empresa en el mercado actual.
          </p>
  ...
  <div class="w3l-content-1 py-5">
    <div class="container py-lg-5 py-md-4 py-2">
      <div class="w3l-content-inf text-center">
        ...
        <p class="para-sub pr-lg-5 mt-md-4 mt-3 mx-auto"> Tenemos amplia experiencia en el desarrollo de páginas web,
          montaje de servidores web, de correo electrónico y muchos más servicios informáticos para hacer crecer tu
          empresa.
        </p>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 whybox-wrap pr-lg-5">
          ...
          <div class="whybox-wrap-grid mb-4">
            ...
            <div class="info">
              ...
              <p class="mt-3">Atraemos clientes potenciales a tu negocio por medio de diferentes herramientas
                electrónicas </p>
            </div>
          </div>
        </div>
        <div class="col-lg-6 whybox-wrap-img mt-lg-0 mt-5 pl-lg-5">
          <div class="w3l-img-hr position-relative">
            <img src="images/pic-4.png" alt="" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row mt-4 py-md-2 mb-md-4">
          <div class="col-lg-6 item">
            <div class="testimonial-content">
              ...
              <div class="bottom-info mt-4">
                <a class="comment-img" href="#url"><img src="images/team1.jpg" class="img-responsive"
          ...
          <div class="col-lg-6 item mt-lg-0 mt-5">
            <div class="testimonial-content">
              ...
              <div class="bottom-info mt-4">
                <a class="comment-img" href="#url"><img src="images/team2.jpg" class="img-responsive"
                    alt="placeholder image"></a>
                <div class="people-info align-self">
